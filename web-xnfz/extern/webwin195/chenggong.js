...
(lib.MC光 = function(mode,startPosition,loop) {
	...
	// 图层_1
	this.instance = new lib.光("synched",0);
	this.instance.parent = this;
...
// stage content:
(lib.chenggong = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 恭喜您
	this.instance = new lib.MC光();
	this.instance.parent = this;
	this.instance.setTransform(961,296.5);

	this.instance_1 = new lib.成功();
	this.instance_1.parent = this;
	this.instance_1.setTransform(380.5,181.5);
...
lib.properties = {
	...
	opacity: 0.00,
	manifest: [
		{src:"images/成功_.png?1589616341659", id:"成功"},
		{src:"images/光2.png?1589616341659", id:"光2"},
		{src:"images/Q1_2.png?1589616341659", id:"Q1_2"}
	],
	preloads: []
};
