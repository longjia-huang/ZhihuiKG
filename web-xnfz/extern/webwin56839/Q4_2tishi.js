...
(lib.Q4_2_caozuotips = function() {
	this.initialize(img.Q4_2_caozuotips);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,803,249);


(lib.小提示 = function(mode,startPosition,loop) {
	...
	// 图层_5
	this.instance = new lib.Q4_2_caozuotips();
	this.instance.parent = this;
	this.instance.setTransform(4,-44,0.667,0.667);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(26));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(4,-44,535.6,166.1);


// stage content:
(lib.Q4_2tishi = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 图层_1
	this.instance = new lib.小提示();
	this.instance.parent = this;
	this.instance.setTransform(0.1,96.6,1,1,0,0,0,3.9,47.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(268.2,94,535.6,166.1);
// library properties:
lib.properties = {
	id: '8B63EE4913D27B469A86E420441823D2',
	width: 536,
	height: 177,
	fps: 30,
	color: "#000000",
	opacity: 0.00,
	manifest: [
		{src:"images/Q4_2_caozuotips.png?1665207996694", id:"Q4_2_caozuotips"}
	],
	preloads: []
};
...
an.compositions['8B63EE4913D27B469A86E420441823D2'] = {
