...
TQPr.handleInteractions = function( res, cid, sid, lid, el, di, sv, incqt, tmstmp, forcetf )
{
  ...
  // zzl 解决组装人员赋值类型错误问题
  var strOurAns = this.strOurAns;
  if (Object.prototype.toString.call(strOurAns)==='[object Array]') {
    strOurAns = strOurAns.join(',');
  }
  var strID = null;
  var strIDSave = null;
  var strTimeID	= null;
    ...
    switch( this.type )
    {
      case jTitleManager.TF:
        ...
        if( forcetf )
        {
          ...
          if( this.arChoices.indexOf( strOurAns ) == 0 )
            strAnswer = "true";
          else
            strAnswer = "false";
        }
        else
        {
            ...
            strAnswer = strOurAns.toLowerCase();
        }
        strID += this.id;
        break;
      ...
      case jTitleManager.OR:
        ...
        var tempStrOurAns = strOurAns.replace(/&#44/g,",");
      ...
      case jTitleManager.MR:
        ...
        if( bGradeInd )
        {
          ...
          bChSel = IsChoiceSelected( this.arChoices[subIdx].replace(/,/g,"&#44"), strOurAns );
      ...
      case jTitleManager.DD:
        ...
        var oArr  = strOurAns.length > 0 ? strOurAns.split(",") : [];
    ...
    if( bGradeable )
    {
      if( bGradeInd ) 
      {
        ...
        else
        {
          ...
          strTemp = GetMatchingPairStr( strQNum, strOurAns );
