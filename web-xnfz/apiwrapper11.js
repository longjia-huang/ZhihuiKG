...
{
   var mockData = {};
   mockData['cmi.core.student_id'] = 'offline-student';
   mockData['cmi.core.student_name'] = 'Offline Student';
   mockData['cmi.core.lesson_status'] = 'not attempted';
   mockData['cmi.core.lesson_location'] = '';
   mockData['cmi.core.session_time'] = '00:00:00';
   mockData['cmi.core.exit'] = '';
   mockData['cmi.core.score.raw'] = '';
   mockData['cmi.core.score.min'] = '';
   mockData['cmi.core.score.max'] = '';
   mockData['cmi.suspend_data'] = '';
   mockData['cmi.core.lesson_mode'] = 'normal';
   mockData['cmi.core.credit'] = 'credit';

   return {
      LMSInitialize: function() { return "true"; },
      LMSFinish: function() { return "true"; },
      LMSGetValue: function(name) {
         return (mockData[name] !== undefined) ? mockData[name] : "";
      },
      ...
      LMSGetDiagnostic: function(code) { return "No error (offline mode)"; }
   };
}
